...
def get_derived_demo():
    ...
    result = get_derived(htsc_code=["601688.SH", "601686.SH", "000001.SZ"], trading_day=[start_date, end_date],
                         type="cr")
    print(result)
...
def main():
    ...
    # get_stock_info_demo()                     # 股票基础信息 按照证券ID获取股票基本信息
    # get_all_stocks_info_demo()                # 股票基础信息 按照市场获取股票基本信息
    # get_trading_days_demo()                   # 交易日历
    # get_new_share_demo()                      # 新股上市
    # get_daily_basic_demo()                    # 日行情接口
    # get_stock_valuation_demo()                # 市值数据
    # get_bond_info_demo()                      # 债券基础信息-通过华泰证券代码查询
    # get_all_bonds_demo()                      # 债券基础信息-通过华泰证券市场查询
    ...
    # get_hk_industry_demo()                    # 港股行业分类-按标的查询
